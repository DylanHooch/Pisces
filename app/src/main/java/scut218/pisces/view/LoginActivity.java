...
public class LoginActivity extends AppCompatActivity {
    ...
    private final String serverHost="119.29.242.116";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((ClientNetworkImpl)(UtilFactory.getNetworkUtil())).setUser("test");
        new Thread(new Runnable() {
            @Override
            public void run() {
                UtilFactory.getNetworkUtil().init(serverHost);
                try {
                    InputStream is = getAssets().open("default.jpg");
                    Log.e("path",getFilesDir().getPath());
                    FileOutputStream fos = new FileOutputStream(new File(getFilesDir().getPath()+"/default.jpg"));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                ((ClientNetworkImpl)(UtilFactory.getNetworkUtil())).setUser(mId);
